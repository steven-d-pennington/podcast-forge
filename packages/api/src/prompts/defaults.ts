...
export const DEFAULT_PROMPT_TEMPLATES: PromptTemplate[] = [
  ...
  template(
    ...
    [
      ...
      'Return at most 6 high-value claims. Prefer fewer, clearer claims over exhaustive paraphrase.',
      ...
      'Keep each claim text under 180 characters.',
      'Use at most one citation object per claim. Include sourceDocumentId and url; omit long title or quote fields unless essential.',
      'If the source is boilerplate, paywalled, empty, or off-topic, return an empty claims array plus warnings instead of forcing claims.',
      '',
      'Source summary:',
      '{{source_summary}}',
      '',
  ...
  template(
    ...
    [
      ...
      'Keep the synthesis concise: at most 8 knownFacts, 6 openQuestions, and 8 synthesized claims.',
      'Keep each synthesized claim under 180 characters and use at most one short citation object per claim.',
      'If evidence is thin or off-topic, return explicit warnings instead of padding the packet.',
      '',
      'Candidate:',
      '{{candidate_json}}',
      '',
