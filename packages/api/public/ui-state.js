...
export const els = {
  ...
  candidateFilterSummary: document.querySelector('#candidateFilterSummary'),
  candidatePublishedFilter: document.querySelector('#candidatePublishedFilter'),
  candidateStatusFilter: document.querySelector('#candidateStatusFilter'),
  candidateQualityFilter: document.querySelector('#candidateQualityFilter'),
  candidateSourceFilter: document.querySelector('#candidateSourceFilter'),
  candidateDomainFilter: document.querySelector('#candidateDomainFilter'),
  clearCandidateFilters: document.querySelector('#clearCandidateFilters'),
